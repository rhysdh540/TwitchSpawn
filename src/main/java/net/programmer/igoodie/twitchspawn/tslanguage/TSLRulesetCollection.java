...
public class TSLRulesetCollection {
	...
	private final TSLRuleset defaultRuleset;
	private final Map<String, TSLRuleset> streamerRulesets; // Maps lowercase nicks to TSLTree
	private final Map<String, EventQueue> eventQueues; // Maps lowercase nicks to TimeTaskQueue
