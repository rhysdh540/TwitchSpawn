...
public class TSLParser {
	...
	private static final Pattern PERCENTAGE_PATTERN = Pattern.compile("(?<decimal>\\d{1,3})(\\.(?<fraction>\\d{1,2}))?");
	...
	private final Map<String, TSLEvent> events; // E.g "twitch follow" -> { TSLEvent }
